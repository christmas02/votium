<div class="topbar">
    <div class="container topbar-inner">
        ...
        <nav aria-label="Navigation principale" class="nav">
            {{-- <a href="{{ route('business.espace') }}" class="{{ request()->routeIs('espace') ? 'active' : '' }}">
            ...
            <a href="{{ route('business.espace') }}"
                class="{{ request()->routeIs('business.espace') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M3 10.5 12 3l9 7.5V21a1 1 0 0 1-1 1h-5v-7H9v7H4a1 1 0 0 1-1-1z"></path>
                </svg>
                Accueil
            ...
            class="{{ request()->routeIs('business.list_campagne') ? 'active' : '' }}">
            ...
            <a href="{{ route('business.list_candidat') }}"
                class="{{ request()->routeIs('business.list_candidat') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2"
                    viewbox="0 0 24 24">
            ...
            <a href="{{ route('business.list_vote') }}"
                class="{{ request()->routeIs('business.list_vote') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2"
                    viewbox="0 0 24 24">
                    <path d="M9 11l3 3L22 4"></path>
                    <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>
                </svg>Votes</a>
            {{-- <a href="#"><svg fill="none" stroke="currentColor" stroke-width="2" viewbox="0 0 24 24">
                    <path
            ...
            <a href="{{ route('business.list_retrait') }}"
                class="{{ request()->routeIs('business.list_retrait') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2"
                    viewbox="0 0 24 24">
