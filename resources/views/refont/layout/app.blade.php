...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .vt-nav-links li a:hover {
            color: #fff;
            background: rgba(255, 255, 255, .09);
        }

        .vt-nav-links li.active a {
            color: #fff;
            background: rgba(255, 255, 255, .13);
        }

        .vt-nav-links li a.vt-nav-disabled {
            opacity: .35;
            cursor: not-allowed;
            pointer-events: none;
        }
        ...
        .vt-promoteur-btn:hover,
        .vt-promoteur-btn:focus {
            background: var(--vt-orange-hover);
        }

        .vt-promoteur-btn::after {
            display: none;
        }
...
<body>
    ...
    <footer class="vt-footer">
        With ❤️ by VOTIUM &bull; Tout droit réservé &copy; {{ date('Y') }}
    </footer>
