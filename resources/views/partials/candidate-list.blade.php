        ...
        <div class="col-md-4 col-lg-3 mb-4">
            <div class="candidate-card">
                <div class="candidate-img-wrapper">
                    ...
                    <img src="{{ $candidat->photo ? asset('uploads/'.$candidat->photo) : 'https://placehold.co/400x500?text=Sans+Photo' }}" alt="{{ $candidat->name }}">
                </div>
                <div class="card-body-custom">
                    ...
                    <div class="vote-row">
                        <div class="candidate-number">
                            <small>Numéro</small>
                            {{ strtoupper(substr($candidat->candidat_id, 0, 3)) }}
                        </div>
                    ...
                    <div class="vote-selection-wrapper" id="vote-{{ $candidat->candidat_id }}">
                        ...
                        @if($packages)
                            @foreach($packages as $p)
                                <div class="vote-item" data-votes="{{ $p->vote }}">
