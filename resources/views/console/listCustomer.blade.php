...
@section('extra-css')
    <style>
        ...
        /* Body + section */
        /* Rendre le modal-body scrollable */
        .modal-body,
        .vt-mbody {
            max-height: 65vh;
            overflow-y: auto;
        ...
        .vt-ac-btn-choose input[type="file"] {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        .vt-social-input:focus {
            outline: none;
            border-color: var(--vt-orange);
            background: #fff;
        }

        .vt-social-input::placeholder {
            color: #b0bec5;
        }
            ...
            <table class="vt-lc-table">
                ...
                <tbody id="lc-tbody">
                    @forelse ($customers as $customer)
                        <tr class="lc-row"
                            data-search="{{ strtolower($customer->entreprise . ' ' . $customer->email . ' ' . $customer->phonenumber) }}">
                            <td>
                            ...
                            <td>
                                <div class="vt-lc-actions">
                                    ...
                                    <button type="button" class="vt-lc-btn del" title="Supprimer" data-bs-toggle="modal"
                                        data-bs-target="#delete_contact_{{ $customer->customer_id }}">
                                        <i class="ti ti-trash"></i>
                                    </button>
                                    <button type="button" class="vt-lc-btn-session" data-bs-toggle="modal"
                                        data-bs-target="#modal_add_campaign_{{ $customer->customer_id }}">
...
@section('modals')
    ...
    <div class="modal fade" id="modal_add_client" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form class="ajax-form" id="form_add_client" action="{{ route('console.save_customer') }}" method="POST"
                    ...
                    <div class="vt-mbody">
                        ...
                        <div class="vt-mf-row">
                            ...
                            <div class="vt-mf">
                                ...
                                <div class="vt-mf-wrap">
                                    ...
                                    <input type="text" class="vt-mf-input" name="phonenumber"
                        ...
                        <div class="vt-mf">
                            <label class="vt-mf-label">Email — identifiant de connexion <span
                                    style="color:#ef4444;">*</span></label>
                            <div class="vt-mf-wrap">
                                <i class="ti ti-mail vt-mf-icon"></i>
                                <input type="email" class="vt-mf-input" name="email_customer"
                            ...
                            <div class="vt-ac-logo-info">
                                ...
                                <label class="vt-ac-btn-choose">
                                    ...
                                    <input type="file" name="logo" accept="image/*"
                                        onchange="handleAcLogoPreview(this)">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="vt-mf-row">
                            <div class="vt-mf">
                                <label class="vt-mf-label">Nom de l'organisation <span
                                        style="color:#ef4444;">*</span></label>
                                <div class="vt-mf-wrap">
                        ...
                        <div class="vt-mf-row">
                            <div class="vt-mf">
                                ...
                                <div class="vt-mf-wrap">
                                    <i class="ti ti-mail vt-mf-icon"></i>
                                    <input type="email" class="vt-mf-input" name="email"
                                        placeholder="contact@entreprise.com">
                                </div>
                            </div>
                            <div class="vt-mf">
                                <label class="vt-mf-label">Téléphone entreprise <span
                                        style="color:#ef4444;">*</span></label>
                                <div class="vt-mf-wrap">
                                    <i class="ti ti-phone vt-mf-icon"></i>
                                    <input type="text" class="vt-mf-input phone" name="phonenumber_entreprise"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="vt-mf">
                            ...
                            <div class="vt-mf-wrap">
                                ...
                                <input type="text" class="vt-mf-input" name="adresse" placeholder="Siège social"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="vt-social-grid">
                            <div class="vt-social-item">
                                ...
                                <input type="url" class="vt-social-input" name="link_facebook"
                                    placeholder="Facebook URL">
                            </div>
                            <div class="vt-social-item">
                                <span class="vt-social-prefix"><i class="ti ti-brand-instagram"></i></span>
                                <input type="url" class="vt-social-input" name="link_instagram"
                                    placeholder="Instagram URL">
                            </div>
                            <div class="vt-social-item">
                                <span class="vt-social-prefix"><i class="ti ti-brand-linkedin"></i></span>
                                <input type="url" class="vt-social-input" name="link_linkedin"
                                    placeholder="LinkedIn URL">
                            </div>
                            <div class="vt-social-item">
                                <span class="vt-social-prefix"><i class="ti ti-brand-youtube"></i></span>
                                <input type="url" class="vt-social-input" name="link_youtube"
                                    placeholder="Youtube URL">
                            </div>
                            <div class="vt-social-item">
                                <span class="vt-social-prefix"><i class="ti ti-brand-tiktok"></i></span>
                                <input type="url" class="vt-social-input" name="link_tiktok"
                                    placeholder="Tiktok URL">
                            </div>
                            <div class="vt-social-item">
                                <span class="vt-social-prefix"><i class="ti ti-world"></i></span>
                                <input type="url" class="vt-social-input" name="link_website"
    ...
    {{-- =====================================================
     ...
     ===================================================== --}}
    @foreach ($customers as $customer)
        <div class="modal fade vt-campaign-modal" id="modal_add_campaign_{{ $customer->customer_id }}" tabindex="-1"
                        ...
                        <div class="vt-mbody">
                            ...
                            <div class="vt-mf">
                                ...
                                <div class="vt-mf-wrap">
                                    ...
                                    <input type="text" class="vt-mf-input" name="name"
                                        placeholder="Ex : Élection Miss 2025" required>
                                </div>
                            </div>
                            ...
                            <div class="vt-nc-cover-zone" id="cover-zone-{{ $customer->customer_id }}">
                                ...
                                <img src="#" class="vt-nc-cover-preview"
                                    id="cover-preview-{{ $customer->customer_id }}" alt="">
                                <input type="file" name="image_couverture" class="vt-nc-cover-input" accept="image/*"
                            ...
                            <div class="vt-toggle-row">
                                ...
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" name="text_cover_isActive"
                                        value="1">
                                </div>
                            </div>
                            <div class="vt-toggle-row">
                            ...
                            <div class="vt-toggle-row">
                                ...
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input inscriptionSwitch" type="checkbox"
                            ...
                            <div class="vt-mf-row">
                                <div class="vt-mf">
                                    ...
                                    <div class="vt-color-wrap">
                                        <input type="text" class="vt-color-text" id="cp-{{ $customer->customer_id }}"
                                            value="#000000">
                                        <input type="color" class="vt-color-swatch" name="color_primaire"
                                            value="#000000"
                                ...
                                <div class="vt-mf">
                                    ...
                                    <div class="vt-color-wrap">
                                        <input type="text" class="vt-color-text" id="cs-{{ $customer->customer_id }}"
                                            value="#000000">
                                        <input type="color" class="vt-color-swatch" name="color_secondaire"
                                            value="#000000"
                            ...
                            <div class="vt-mf">
                                <label class="vt-mf-label">Conditions de participation (PDF) <span
                                        style="color:#ef4444;">*</span></label>
                                <div class="vt-mf-wrap">
