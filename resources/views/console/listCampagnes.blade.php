...
<style>
    ...
    /* Cellule session */
    .vt-lc-sess-name { font-weight: 700; font-size: 13px; text-transform: uppercase; }
    ...
    .vt-lc-btn.edit:hover { border-color: #fcd34d; color: #d97706; background: #fffbeb; }
        ...
        <div style="overflow-x:auto;">
            <table class="vt-lc-table">
                ...
                <tbody id="lc-tbody">
                    ...
                    <tr class="lc-row" data-search="{{ strtolower($campagne->name . ' ' . ($customers[$campagne->customer_id] ?? '')) }}">
                        <td><span class="vt-lc-sess-name">{{ $campagne->name }}</span></td>
                        <td style="font-size:12.5px; font-weight:600;">{{ $customers[$campagne->customer_id] ?? '—' }}</td>
                        ...
                        <td style="font-size:12px; color:var(--vt-text-muted);">{{ $campagne->created_at->format('d/m/Y') }}</td>
                        <td>
                            @if($campagne->inscription_isActive)
                                <span class="vt-lc-badge-actif"><i class="ti ti-check" style="font-size:10px;"></i> Autorisées</span>
                            @else
                        ...
                        <td>
                            <div class="vt-lc-actions">
                                <a href="{{ route('console.site_campagne', [$campagne->campagne_id]) }}"
                                   class="vt-lc-btn view" title="Voir le site">
                                    <i class="ti ti-location"></i>
                                </a>
                                <button type="button" class="vt-lc-btn edit" title="Modifier"
                                        data-bs-toggle="modal" data-bs-target="#modal_edit_campaign_{{ $campagne->campagne_id }}">
                                    <i class="ti ti-edit"></i>
                                </button>
                                <button type="button" class="vt-lc-btn del" title="Supprimer"
                                        data-bs-toggle="modal" data-bs-target="#delete_contact_{{ $campagne->campagne_id }}">
                ...
                <div class="vt-mbody">
                    ...
                    <div class="vt-mf">
                        ...
                        <div class="vt-mf-wrap">
                            ...
                            <input type="text" class="vt-mf-input" name="name" placeholder="Ex: Élection Miss 2024" required>
                        </div>
                    </div>
                    ...
                    <div class="vt-nc-cover-zone" id="add-cover-zone">
                        <div class="vt-nc-cover-placeholder">
                            ...
                            <p>Glissez ou cliquez pour choisir une image<br>
                               <span style="font-size:10.5px;">1920×1080 · JPG, PNG · max 2 Mo</span></p>
                        </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" name="text_cover_isActive" value="1">
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" name="identifiants_personnalises_isActive" value="1">
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input inscriptionSwitch" type="checkbox" role="switch" name="inscription_isActive" value="1">
                        </div>
                    </div>
                    ...
                    <div class="vt-insc-bloc blocDates d-none">
                        <div class="vt-mf" style="margin:0;">
                            ...
                            <input type="date" class="vt-mf-input" style="padding-left:12px;" name="inscription_date_debut">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Date fin</label>
                            <input type="date" class="vt-mf-input" style="padding-left:12px;" name="inscription_date_fin">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Heure début</label>
                            <input type="time" class="vt-mf-input" style="padding-left:12px;" name="heure_debut_inscription">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Heure fin</label>
                            <input type="time" class="vt-mf-input" style="padding-left:12px;" name="heure_fin_inscription">
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" name="ordonner_candidats_votes_decroissants" value="1">
                        </div>
                    </div>
                    ...
                    <div class="vt-mf">
                        ...
                        <div class="vt-radio-pills">
                            <input type="radio" name="afficher_montant_pourcentage" id="add_opt_clair" value="clair" checked>
                            <label for="add_opt_clair">Clair</label>
                            <input type="radio" name="afficher_montant_pourcentage" id="add_opt_pct" value="pourcentage">
                            <label for="add_opt_pct">Pourcentage</label>
                            <input type="radio" name="afficher_montant_pourcentage" id="add_opt_deux" value="les_deux">
                    ...
                    <div class="vt-mf-row">
                        <div class="vt-mf">
                            ...
                            <div class="vt-color-wrap">
                                <input type="text" class="vt-color-text" id="add_cprim_txt" value="#000000" maxlength="7"
                                       oninput="syncColorSwatch(this,'add_cprim_sw')">
                                <input type="color" class="vt-color-swatch" id="add_cprim_sw" name="color_primaire" value="#000000"
                        ...
                        <div class="vt-mf">
                            ...
                            <div class="vt-color-wrap">
                                <input type="text" class="vt-color-text" id="add_csec_txt" value="#000000" maxlength="7"
                                       oninput="syncColorSwatch(this,'add_csec_sw')">
                                <input type="color" class="vt-color-swatch" id="add_csec_sw" name="color_secondaire" value="#000000"
...
<div class="modal fade vt-edit-campaign" id="modal_edit_campaign_{{ $campagne->campagne_id }}"
            ...
            <form class="ajax-form" action="{{ route('console.update_campagne') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="vt-mbody">
                    ...
                    <div class="vt-mf">
                        ...
                        <div class="vt-mf-wrap">
                            <i class="ti ti-forms vt-mf-icon"></i>
                            <input type="text" class="vt-mf-input" name="name" value="{{ $campagne->name }}" required>
                        </div>
                    </div>
                    ...
                    <div class="vt-mf">
                        ...
                        <div class="vt-mf-wrap">
                            ...
                            <select class="vt-mf-select" name="customer_id" required>
                                @foreach($customers as $customerId => $entreprise)
                                <option value="{{ $customerId }}" {{ $campagne->customer_id == $customerId ? 'selected' : '' }}>
                                    {{ $entreprise }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="vt-nc-cover-zone"
                         id="edit-cover-zone-{{ $campagne->campagne_id }}"
                        ...
                        <img class="vt-nc-cover-preview"
                             id="edit-cover-preview-{{ $campagne->campagne_id }}"
                             src="{{ $campagne->image_couverture ? env('IMAGES_PATH').'/'.$campagne->image_couverture : '#' }}"
                             alt=""
                             style="{{ $campagne->image_couverture ? 'display:block;' : '' }}">
                        <input type="file" class="vt-nc-cover-input" name="image_couverture" accept="image/*"
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch"
                                   name="text_cover_isActive" value="1" {{ $campagne->text_cover_isActive ? 'checked' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch"
                                   name="identifiants_personnalises_isActive" value="1" {{ $campagne->identifiants_personnalises_isActive ? 'checked' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input inscriptionSwitch" type="checkbox" role="switch"
                                   name="inscription_isActive" value="1" {{ $campagne->inscription_isActive ? 'checked' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="vt-insc-bloc blocDates {{ $campagne->inscription_isActive ? '' : 'd-none' }}">
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Date début</label>
                            <input type="date" class="vt-mf-input" style="padding-left:12px;" name="inscription_date_debut" value="{{ $campagne->inscription_date_debut }}">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Date fin</label>
                            <input type="date" class="vt-mf-input" style="padding-left:12px;" name="inscription_date_fin" value="{{ $campagne->inscription_date_fin }}">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Heure début</label>
                            <input type="time" class="vt-mf-input" style="padding-left:12px;" name="heure_debut_inscription" value="{{ $campagne->heure_debut_inscription }}">
                        </div>
                        <div class="vt-mf" style="margin:0;">
                            <label class="vt-mf-label">Heure fin</label>
                            <input type="time" class="vt-mf-input" style="padding-left:12px;" name="heure_fin_inscription" value="{{ $campagne->heure_fin_inscription }}">
                        </div>
                    </div>
                    ...
                    <div class="vt-toggle-row">
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch"
                                   name="ordonner_candidats_votes_decroissants" value="1" {{ $campagne->ordonner_candidats_votes_decroissants ? 'checked' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="vt-mf-row">
                        <div class="vt-mf">
                            ...
                            <div class="vt-color-wrap">
                                ...
                                <input type="color" class="vt-color-swatch"
                                       id="edit_cprim_sw_{{ $campagne->campagne_id }}"
                                       name="color_primaire" value="{{ $campagne->color_primaire }}"
                        ...
                        <div class="vt-mf">
                            ...
                            <div class="vt-color-wrap">
                                ...
                                <input type="color" class="vt-color-swatch"
                                       id="edit_csec_sw_{{ $campagne->campagne_id }}"
                                       name="color_secondaire" value="{{ $campagne->color_secondaire }}"
                    ...
                    <div style="margin-bottom: 8px;">
                        <a href="{{ env('IMAGES_PATH') }}/{{ $campagne->condition_participation }}" target="_blank"
