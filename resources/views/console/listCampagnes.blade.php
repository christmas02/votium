                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-flex gap-2">
                                            <a href="{{ route('detail_campagne', [$campagne->campagne_id]) }}" class="btn btn-icon btn-sm btn-success"><i class="ti ti-location"></i></a>
...
<div class="modal fade" id="modal_edit_campaign_{{$campagne->campagne_id}}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('update_campagne') }}" method="POST" enctype="multipart/form-data">
                    @csrf
