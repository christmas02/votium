...
<head>
    ...
    <meta name="description"
        content="VOTIUM vous aide à créer, gérer et suivre vos campagnes de votes en toute simplicité.">
    <title>VOTIUM — Inscription</title>
    ...
    <header class="topbar" role="banner">
        <div class="topbar-inner container">
            ...
            <nav class="public-links" aria-label="Navigation publique">
                <a href="/#pourquoi">Pourquoi VOTIUM</a>
    ...
    <main class="auth-main">
        <div class="container auth-grid">
            <section class="auth-left">
                ...
                <h1>Inscription</h1>
                <p class="muted">Créez votre compte promoteur pour lancer vos campagnes.</p>
            ...
            <section class="auth-card">
                <div class="card">
                    ...
                    <form class="form" action="{{ route('screenRegister') }}" method="POST" autocomplete="on">

                        @csrf

                        <label class="field">
                            <span>Nom & prénom</span>
                            <input type="text" name="name" placeholder="ex: Florent Toh" required>
                        </label>
                        <label class="field">
                            <span>Téléphone</span>
                            <input type="tel" name="phone" placeholder="+225 XX XX XX XX" required>
                        </label>
                        <label class="field">
                            <span>Email</span>
                            <input type="email" name="email" placeholder="ex: contact@domaine.com" required>
                        </label>
                        <label class="field">
                            <span>Mot de passe</span>
                            <input type="password" name="password" placeholder="••••••••" required>
                        </label>
                        <button class="btn primary w100" type="submit">Créer mon compte</button>
                        <p class="small muted" style="margin-top:10px">En créant votre compte, vous acceptez nos
                            conditions d’utilisation.</p>

                    </form>

                    <p class="small muted" style="margin-top:14px">Déjà un compte ? <a class="link"
                            href="{{ route('screenLogin') }}">Se connecter</a></p>
                </div>
            </section>
        </div>
    </main>
