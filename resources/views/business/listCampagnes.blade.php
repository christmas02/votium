...
<style>
    ...
    .vt-modal-close:hover { border-color: #94a3b8; color: var(--vt-text-main); }

    /* Labels uppercase orange */
    .vt-ns-label {
        font-size: 10.5px; font-weight: 700;
        letter-spacing: 1px; text-transform: uppercase;
        color: var(--vt-text-muted); margin-bottom: 7px; display: block;
    }
    ...
    .vt-ns-input:focus { outline: none; border-color: var(--vt-orange); }
    .vt-ns-input::placeholder { color: #94a3b8; }
    textarea.vt-ns-input { resize: vertical; min-height: 90px; }
    ...
    .vt-ns-select:focus { outline: none; border-color: var(--vt-orange); }
    ...
    .vt-ns-dropzone {
        ...
        gap: 12px; position: relative; transition: border-color .15s;
        overflow: hidden;
    }
    .vt-ns-dropzone:hover { border-color: #94a3b8; }
    .vt-ns-dropzone-text { font-size: 12.5px; color: var(--vt-text-muted); flex: 1; }
    .vt-ns-dropzone-btn {
        background: var(--vt-orange); color: #fff;
        border: none; border-radius: 6px;
        padding: 6px 14px; font-size: 12px; font-weight: 600;
        cursor: pointer; flex-shrink: 0; white-space: nowrap; position: relative; z-index: 1;
    }
    ...
    .vt-ns-option {
        ...
        cursor: pointer; transition: border-color .15s; gap: 12px;
    }
    .vt-ns-option:hover { border-color: #94a3b8; }
    .vt-ns-option input[type="checkbox"] {
        width: 16px; height: 16px;
        accent-color: var(--vt-orange); flex-shrink: 0; cursor: pointer;
    }
    .vt-ns-option-text { flex: 1; }
    .vt-ns-option-title { font-size: 13px; font-weight: 600; color: var(--vt-text-main); margin: 0 0 2px; }
    .vt-ns-option-desc  { font-size: 11.5px; color: var(--vt-text-muted); margin: 0; }

    /* Radio pills */
    .vt-ns-radio-pills { display: flex; gap: 6px; flex-shrink: 0; flex-wrap: wrap; }
    .vt-ns-radio-pills input[type="radio"] { display: none; }
    .vt-ns-radio-pills label {
        padding: 5px 14px; border-radius: 50px;
        border: 1.5px solid var(--vt-border);
        font-size: 12px; font-weight: 600; color: var(--vt-text-muted);
        cursor: pointer; transition: all .15s; white-space: nowrap;
    }
    .vt-ns-radio-pills input[type="radio"]:checked + label {
        background: var(--vt-orange); color: #fff; border-color: var(--vt-orange);
    }
    ...
    /* Hint */
    .vt-ns-hint { font-size: 11.5px; color: var(--vt-orange); margin: 6px 0 0; font-style: italic; }

    /* Section étape active */
    .vt-ns-section-title {
        font-size: 10.5px; font-weight: 700; letter-spacing: 1px;
        text-transform: uppercase; color: var(--vt-orange);
        margin-bottom: 4px; display: block;
    }
    .vt-ns-section-desc { font-size: 11.5px; color: var(--vt-orange); margin-bottom: 14px; line-height: 1.5; }
    ...
    .vt-ns-btn-cancel:hover { border-color: #94a3b8; }
    .vt-ns-btn-submit {
    ...
    .vt-ns-btn-submit:hover { background: var(--vt-orange-hover); }
</style>
@endsection
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
            ...
            <div class="modal-body" style="padding: 22px 24px 0;">
                <form class="ajax-form" action="{{ route('business.save_campagne') }}"
                      method="POST" enctype="multipart/form-data" id="form-new-session">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-8">
                            ...
                            <input type="text" class="vt-ns-input" name="name"
                                   placeholder="Ex: Finale CNC 2026" required
                        ...
                        <div class="col-4">
                            ...
                            <input type="hidden" name="inscription_isActive" id="inscription_isActive_hidden" value="1">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="vt-ns-input" name="description" rows="4"
                                  placeholder="But, durée, règles, infos utiles..." required></textarea>
                    </div>
                    ...
                    <label class="vt-ns-option" for="textCoverSwitch">
                        <div class="vt-ns-option-text">
                            ...
                            <p class="vt-ns-option-desc">Afficher un titre/infos au-dessus de l'image de couverture.</p>
                        </div>
                    ...
                    <label class="vt-ns-option" for="identifiantsSwitch">
                        ...
                        <input type="checkbox" id="identifiantsSwitch" name="identifiants_personnalises_isActive" value="1">
                    </label>
                    ...
                    <div class="vt-ns-option" style="cursor: default;">
                        ...
                        <div class="vt-ns-radio-pills">
                            <input type="radio" name="afficher_montant_pourcentage" id="aff_clair" value="clair" checked>
                            <label for="aff_clair">Clair</label>
                            <input type="radio" name="afficher_montant_pourcentage" id="aff_pct" value="pourcentage">
                            <label for="aff_pct">Pourcentage</label>
                            <input type="radio" name="afficher_montant_pourcentage" id="aff_deux" value="les_deux">
                    ...
                    <label class="vt-ns-option" for="ordonnerSwitch">
                        ...
                        <input type="checkbox" id="ordonnerSwitch" name="ordonner_candidats_votes_decroissants" value="1">
                    </label>
                    ...
                    {{-- ----------------------------------------
                         ÉTAPE ACTIVE
                         ---------------------------------------- --}}
                    <div class="mb-4" style="padding: 18px; background: #fdf6f0; border-radius: var(--vt-radius-sm); border: 1px solid var(--vt-orange-border);">
                        <span class="vt-ns-section-title">Étape active (pour démarrer/arrêter les votes)</span>
                        <p class="vt-ns-section-desc">
                            Exemples : Présélection, Demi-finale, Finale. Cette étape pilote l'état "Votes en cours" / "Fin des votes" côté public.
                        </p>
                        <div class="row g-3">
                            <div class="col-6">
                                <label class="vt-ns-label">Nom de l'étape</label>
                                <input type="text" class="vt-ns-input" name="etape_name"
                                       placeholder="ONE" value="ONE">
                            </div>
                            <div class="col-6">
                                <label class="vt-ns-label">Début</label>
                                <input type="datetime-local" class="vt-ns-input" name="etape_date_debut">
                            </div>
                            <div class="col-6">
                                <label class="vt-ns-label">Fin</label>
                                <input type="datetime-local" class="vt-ns-input" name="etape_date_fin">
                            </div>
                            <div class="col-6">
                                <label class="vt-ns-label">Statut</label>
                                <select class="vt-ns-select" name="etape_statut">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6">
                            ...
                            <div class="vt-ns-color-wrap">
                                <input type="text" class="vt-ns-color-text" id="cp-text-new"
                                       value="#01233f" maxlength="7"
                                       oninput="syncColor('cp-text-new','cp-swatch-new','cp-display-new')">
                                <div class="vt-ns-color-display" id="cp-display-new"
                                     style="background:#01233f;" title="Choisir">
                        ...
                        <div class="col-6">
                            ...
                            <div class="vt-ns-color-wrap">
                                <input type="text" class="vt-ns-color-text" id="cs-text-new"
                                       value="#f17100" maxlength="7"
                                       oninput="syncColor('cs-text-new','cs-swatch-new','cs-display-new')">
                                <div class="vt-ns-color-display" id="cs-display-new"
                                     style="background:#f17100;" title="Choisir">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="vt-ns-dropzone" style="height: 52px;">
                            ...
                            <button type="button" class="vt-ns-dropzone-btn" style="background: var(--vt-navy);">Insérer</button>
...
/* Sync inscriptions select → hidden input */
document.addEventListener('DOMContentLoaded', function() {
    const sel = document.getElementById('inscriptions-select');
    if (sel) {
        sel.addEventListener('change', function() {
            document.getElementById('inscription_isActive_hidden').value = this.value;
        });
    }
});
</script>
...
<div class="modal fade" id="modal_edit_campaign_{{ $cid }}" tabindex="-1"
        ...
        <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
            ...
            <div class="modal-body" style="padding: 22px 24px 0;">
                <form class="ajax-form"
                      action="{{ route('business.update_campagne') }}"
                      method="POST"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-4">
                            ...
                            <select class="vt-ns-select"
                                    onchange="document.getElementById('inscr-hidden-{{ $cid }}').value = this.value">
                                <option value="1" {{ $item['campagne']->inscription_isActive ? 'selected' : '' }}>Autorisées</option>
                                <option value="0" {{ !$item['campagne']->inscription_isActive ? 'selected' : '' }}>Non-autorisées</option>
                            </select>
                    ...
                    <div class="mb-4 image-upload-group">
                        ...
                        <div class="vt-ns-dropzone drop-zone-target"
                            ...
                            <div class="placeholder-target{{ $item['campagne']->image_couverture ? ' d-none' : '' }}">
                                <span class="vt-ns-dropzone-text">
                            ...
                            <img src="{{ $item['campagne']->image_couverture ? asset(env('IMAGES_PATH').'/'.$item['campagne']->image_couverture) : '#' }}"
                                 alt="Aperçu"
                                 class="vt-ns-dropzone-preview preview-target"
                    ...
                    <label class="vt-ns-option" for="textCover-{{ $cid }}">
                        ...
                        <input type="checkbox" id="textCover-{{ $cid }}"
                               name="text_cover_isActive" value="1"
                               {{ $item['campagne']->text_cover_isActive ? 'checked' : '' }}>
                    </label>
