...
<style>
    ...
    .vt-ret-filter-title {
        ...
        color: var(--vt-text-main); margin: 0 0 16px;
    }
    .vt-ret-field-label {
    ...
    .vt-ret-select:focus, .vt-ret-date:focus { outline: none; border-color: var(--vt-orange); }
    ...
    .vt-solde-immediate .label { font-size: 11.5px; color: #166534; margin-bottom: 4px; }
    .vt-solde-immediate .value {
        font-size: 24px; font-weight: 800; color: #16a34a;
        display: flex; align-items: baseline; gap: 6px;
    }
    .vt-solde-immediate .value .unit { font-size: 12px; font-weight: 600; }
    ...
    .vt-solde-demande .label { font-size: 11.5px; color: var(--vt-text-muted); margin-bottom: 4px; }
    .vt-solde-demande .value {
        font-size: 24px; font-weight: 800; color: var(--vt-text-main);
        display: flex; align-items: baseline; gap: 6px;
    }
    .vt-solde-demande .value .unit { font-size: 12px; font-weight: 600; color: var(--vt-text-muted); }
    ...
    .vt-solde-total .label { font-size: 11.5px; color: rgba(255,255,255,.6); margin-bottom: 4px; }
    .vt-solde-total .value {
        font-size: 26px; font-weight: 800; color: #fff;
        display: flex; align-items: baseline; gap: 6px;
    }
    .vt-solde-total .value .unit { font-size: 13px; font-weight: 600; opacity: .7; }

    .vt-retrait-remaining {
        font-size: 13px; color: var(--vt-text-muted); line-height: 1.5;
    }
    .vt-retrait-remaining strong { color: var(--vt-orange); }

    /* ---- Colonne droite (tableau) ---- */
    .vt-ret-main { flex: 1; min-width: 0; }
    .vt-ret-table-card {
        background: var(--vt-card-bg);
        border-radius: var(--vt-radius);
        box-shadow: var(--vt-shadow);
    ...
    .vt-ret-hist-label {
        ...
        color: var(--vt-text-main); white-space: nowrap;
    }
    .vt-ret-ops-count {
        font-size: 12.5px; color: var(--vt-orange);
    ...
    .vt-ctrl-label {
        ...
        letter-spacing: .5px; color: var(--vt-text-muted);
    ...
    .vt-ctrl-select:focus { outline: none; border-color: var(--vt-orange); }
    .vt-ctrl-date {
        padding: 6px 9px;
        border: 1px solid var(--vt-border);
        border-radius: var(--vt-radius-sm);
    ...
    .vt-ctrl-date:focus { outline: none; border-color: var(--vt-orange); }
    .vt-ctrl-search {
        padding: 6px 12px;
        border: 1px solid var(--vt-border);
        border-radius: var(--vt-radius-sm);
    ...
    .vt-ctrl-search::placeholder { color: #94a3b8; }
    .vt-ctrl-search:focus { outline: none; border-color: var(--vt-orange); }
    ...
    .vt-ret-table tbody tr:last-child td { border-bottom: none; }
    .vt-ret-table tbody tr:hover td { background: #fafbfc; }
    .vt-ret-table .cell-ref { font-weight: 600; color: var(--vt-orange); }
    .vt-ret-table .cell-dest { font-weight: 600; }
    .vt-ret-table .cell-montant { font-weight: 700; }

    .vt-ret-empty {
        padding: 32px 16px;
        text-align: center; color: var(--vt-text-muted);
        font-size: 13px;
    }
    ...
    .vt-modal-icon-wrap {
        ...
        font-size: 18px; color: var(--vt-orange);
        flex-shrink: 0;
    }
    ...
    .vt-modal-retrait .modal-body { padding: 22px 22px 14px; }

    /* Champs modal */
    .vt-modal-field { margin-bottom: 16px; }
    .vt-modal-field label {
        font-size: 12px; font-weight: 600;
        color: var(--vt-text-muted); display: block; margin-bottom: 5px;
    }
    .vt-modal-input-wrap { position: relative; }
    .vt-modal-input-wrap .mi-icon {
        position: absolute; left: 11px; top: 50%; transform: translateY(-50%);
        color: #94a3b8; font-size: 14px; pointer-events: none;
    }
    .vt-modal-select, .vt-modal-input {
        width: 100%;
    ...
    .vt-modal-select:focus, .vt-modal-input:focus { outline: none; border-color: var(--vt-orange); }
    .vt-modal-hint {
        font-size: 11.5px; color: var(--vt-text-muted);
        margin: -8px 0 12px;
    }
    ...
    .vt-btn-modal-cancel:hover { border-color: #94a3b8; }
    ...
    .vt-btn-modal-confirm:hover { background: var(--vt-orange-hover); }

    @media (max-width: 860px) {
        .vt-ret-layout { flex-direction: column; }
        .vt-ret-filter { width: 100%; }
        .vt-ret-controls-top { flex-wrap: wrap; }
    }
</style>
@endsection
...
@section('content')
    ...
    <div class="vt-ret-header">
        ...
        <button class="vt-btn-primary" style="border-radius: 50px; padding: 10px 22px;"
        ...
        <div class="vt-ret-filter">
            ...
            <div class="vt-ret-input-wrap">
                ...
                <select class="vt-ret-select" id="filter-destination">
                    ...
                    <option value="mara_wave">Mara Wave</option>
                    <option value="mara_momo">Mara Momo</option>
                    <option value="arthur_om">Arthur OM</option>
                </select>
            </div>
            ...
            <div class="vt-ret-input-wrap">
                ...
                <input type="date" class="vt-ret-date" id="filter-date-debut"
            ...
            <div class="vt-ret-input-wrap">
                <i class="ti ti-calendar ri-icon"></i>
                <input type="date" class="vt-ret-date" id="filter-date-fin"
                       placeholder="jj/mm/aaaa">
            </div>
                    ...
                    <table class="vt-ret-table" id="table-retraits">
                        ...
                        <tbody id="retraits-tbody">
                            ...
                            <tr>
                                ...
                                <td><span class="vt-status-confirmed"><i class="ti ti-check" style="font-size:10px;"></i> Confirmé</span></td>
                            </tr>
                            <tr>
...
{{-- =====================================================
     MODAL — DEMANDE DE RETRAIT
     ===================================================== --}}
<div class="modal fade vt-modal-retrait" id="modalRetrait" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 480px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="ajax-form" action="#" method="POST" id="form-retrait">
                    @csrf
                        ...
                        <div class="col-6">
                            <div class="vt-modal-field">
                                ...
                                <div class="vt-modal-input-wrap">
                                    ...
                                    <input type="number" class="vt-modal-input"
                                           name="montant"
                        ...
                        <div class="col-6">
                            <div class="vt-modal-field">
                                ...
                                <div class="vt-modal-input-wrap">
                                    ...
                                    <input type="text" class="vt-modal-input"
                                           name="motif"
            ...
            <div class="modal-footer">
                <button type="button" class="vt-btn-modal-cancel"
...
$(document).ready(function () {
    ...
    /* -------------------------------------------------------
       Filtre statut
       ------------------------------------------------------- */
    $('#ctrl-statut').on('change', function () { filterTable(); });
    $('#ctrl-destination').on('change', function () { filterTable(); });
