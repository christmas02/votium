...
<style>
    ...
    .vt-header-actions { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
    ...
    .vt-btn-muted:hover { color: var(--vt-text-main); }
    .vt-btn-outline-dark {
        display: inline-flex; align-items: center; gap: 6px;
    ...
    .vt-btn-outline-dark:hover { border-color: #94a3b8; color: var(--vt-text-main); background: #f8fafc; }
    ...
    .vt-sidebar-section { padding: 18px 18px 0; }
    ...
    .vt-sidebar-label {
        ...
        color: var(--vt-text-muted); margin-bottom: 5px;
    }
    .vt-sidebar-select {
        width: 100%;
        ...
        appearance: none;
        font-size: 13px; font-weight: 500; color: var(--vt-text-main);
        cursor: pointer; transition: border-color .15s;
        margin-bottom: 14px;
    }
    .vt-sidebar-select:focus { outline: none; border-color: var(--vt-orange); }
    .vt-sidebar-select:disabled { opacity: .5; cursor: not-allowed; }

    /* Séparateur */
    .vt-sidebar-divider { height: 1px; background: var(--vt-border); margin: 6px 0 14px; }
    ...
    .vt-cat-heading { font-size: 17px; font-weight: 700; color: var(--vt-text-main); }
    .vt-cat-subtitle { font-size: 11.5px; color: var(--vt-text-muted); padding: 0 18px; margin-bottom: 14px; }
    .vt-cat-add-btn {
        ...
        font-size: 18px; cursor: pointer; font-weight: 300;
        transition: all .15s; flex-shrink: 0;
    }
    .vt-cat-add-btn:hover { border-color: var(--vt-orange); color: var(--vt-orange); background: var(--vt-orange-light); }

    /* Liste catégories */
    .vt-cat-list { padding: 0 12px; flex: 1; overflow-y: auto; max-height: 340px; }
    .vt-cat-item {
    ...
    .vt-cat-item:hover { box-shadow: var(--vt-shadow); }
    .vt-cat-avatar {
        width: 38px; height: 38px; border-radius: 50%;
        background: #fde8cc;
        display: flex; align-items: center; justify-content: center;
        font-size: 15px; font-weight: 700; color: var(--vt-orange);
        flex-shrink: 0;
    }
    .vt-cat-info { flex: 1; min-width: 0; }
    .vt-cat-name {
        font-size: 12.5px; font-weight: 700;
        color: var(--vt-text-main); text-transform: uppercase;
        margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    }
    .vt-cat-count { font-size: 11px; color: var(--vt-text-muted); margin: 0; }
    .vt-cat-actions { display: flex; gap: 5px; flex-shrink: 0; }
    .vt-cat-btn {
    ...
    .vt-cat-btn:hover { border-color: #94a3b8; color: var(--vt-text-main); }
    .vt-cat-btn.danger:hover { border-color: #fca5a5; color: #dc2626; background: #fff5f5; }
    ...
    .vt-sidebar-export:hover { background: var(--vt-orange-hover); color: #fff; }

    /* ---- Colonne droite (contenu candidats) ---- */
    .vt-candidat-main { flex: 1; min-width: 0; }
    ...
    .vt-candidat-search::placeholder { color: #94a3b8; }
    .vt-candidat-search:focus { outline: none; border-color: #94a3b8; }

    /* Grille des candidats (reprise du JS existant) */
    .js-candidat-table-body { /* garde le nom pour le JS */ }
    ...
    .vt-load-more-btn:hover { border-color: #94a3b8; box-shadow: var(--vt-shadow); color: var(--vt-text-main); }

    /* Empty state candidats */
    .vt-candidat-empty {
        background: #fff; border-radius: var(--vt-radius);
    ...
    <div class="vt-page-header-row">
        ...
        <div class="vt-header-actions">
            <a href="javascript:void(0);" class="vt-btn-primary"
               data-bs-toggle="modal" data-bs-target="#modal_add_candidat">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="javascript:void(0);"><i class="ti ti-file-type-csv me-2"></i>Importer en CSV</a></li>
                    <li><a class="dropdown-item" href="javascript:void(0);"><i class="ti ti-file-type-xls me-2"></i>Importer en Excel</a></li>
                </ul>
            </div>
    ...
    <div class="vt-candidat-layout">
        ...
        <div class="vt-candidat-sidebar">
            ...
            <div class="vt-cat-header">
                ...
                <button class="vt-cat-add-btn"
                        data-bs-toggle="modal" data-bs-target="#modal_add_categorie"
            ...
            <div class="vt-cat-list" id="sidebar-categories">
                ...
                <div class="vt-cat-item js-cat-item" data-campagne-id="{{ $cat->campagne_id }}">
                    ...
                    <div class="vt-cat-info">
                        ...
                        <p class="vt-cat-count">0 candidat</p>
                    </div>
                    <div class="vt-cat-actions">
                        <a href="javascript:void(0);"
                           class="vt-cat-btn js-btn-edit-cat"
                           data-id="{{ $cat->category_id }}"
                           data-name="{{ $cat->name }}"
                           data-campagne="{{ $cat->campagne_id }}"
                           data-bs-toggle="modal"
                           data-bs-target="#modal_edit_categorie"
                           title="Modifier">
                            <i class="ti ti-pencil"></i>
                        </a>
                        <a href="javascript:void(0);"
                           class="vt-cat-btn danger js-btn-delete-cat"
                           data-id="{{ $cat->category_id }}"
                           data-bs-toggle="modal"
                           data-bs-target="#modal_delete_categorie"
                           title="Supprimer">
        ...
        <div class="vt-candidat-main">
            ...
            <div class="vt-candidat-search-wrap">
                ...
                <input type="text"
                       class="vt-candidat-search js-search-candidat"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3 image-upload-group">
                            <div class="d-flex align-items-center bg-light p-2 rounded">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <input type="file" class="form-control form-control-sm" name="photo" accept="image/*" onchange="handleImagePreview(this)">
                                    <small class="text-muted">JPG, GIF ou PNG. Max 800K</small>
                                    <button type="button" class="btn btn-sm btn-link text-danger p-0 d-none remove-btn-target text-start" onclick="handleImageRemove(this)">Supprimer</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="etape_id" class="form-select js-add-etape" required disabled>
                                ...
                                @foreach ($etapes as $etape)
                                    <option value="{{ $etape->etape_id }}" data-campagne-id="{{ $etape->campagne_id }}">{{ $etape->name }}</option>
                                @endforeach
                            </select>
                            <small class="text-danger d-none js-msg-no-etape mt-1"><i class="ti ti-info-circle"></i> Aucune étape disponible.</small>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="category_id" class="form-select js-add-categorie" disabled>
                                <option value="">Sélectionner</option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->category_id }}" data-campagne-id="{{ $category->campagne_id }}">{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Présentation du candidat <span class="text-danger">*</span></label>
                            <textarea class="form-control" name="description" rows="4" required placeholder="Parlez brièvement de lui, son parcours, ses ambitions..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer border-top mt-4 pb-0 px-0">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Annuler</button>
                        <button type="submit" class="btn btn-primary js-btn-save-candidat"><i class="ti ti-device-floppy me-1"></i> Enregistrer</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form class="ajax-form" action="{{ route('business.save_categorie') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="campagne_id" required>
                            <option value="">Sélectionner une campagne</option>
                            @foreach ($campagnes as $item)
                                @php($c = $item['campagne'] ?? null)
                                @if($c)
                                <option value="{{ $c->campagne_id }}">{{ $c->name }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
...
<div class="modal fade" id="modal_edit_categorie" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-bottom">
...
<div class="modal fade" id="modal_delete_categorie" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
...
$(document).ready(function () {
    ...
    $('.js-select-campagne').on('change', function () {
        ...
        /* Filtrer les catégories de la sidebar aussi */
        if (campagneId) {
            ...
            /* Afficher/masquer les items catégorie de la sidebar */
    ...
    $(document).on('change', '.js-add-campagne', function () {
        ...
        $selectEtape.empty().prop('disabled', true).append('<option value="">Sélectionner</option>');
    ...
    function renderCandidatCards(candidats, append) {
        ...
        if (candidats.length === 0 && !append) {
            html = '<div class="col-12"><div class="vt-candidat-empty"><i class="ti ti-users" style="font-size:32px; display:block; margin-bottom:8px; opacity:.3;"></i>Aucun candidat trouvé.</div></div>';
    ...
    $('#form_edit_candidat').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                if (xhr.status === 422) {
                    ...
                    $.each(errors, function (fieldName, messages) {
                        let $input = $form.find(`[name="${fieldName}"]`).first();
                        if ($input.length) {
            ...
            complete: function () { $submitBtn.prop('disabled', false).html(originalBtnHtml); }
        });
    });
    ...
    $('#form_delete_candidat').on('submit', function (e) {
        ...
        $.ajax({
            ...
            complete: function () { $submitBtn.prop('disabled', false).html('Oui, supprimer'); }
        });
    });
