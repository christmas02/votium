        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#modal_add_candidat"><i class="ti ti-square-rounded-plus-filled me-1"></i>Créer</a>
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    <div class="dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle btn btn-outline-light px-2 shadow"
                            data-bs-toggle="dropdown"><i class="ti ti-package-import me-2"></i>Importer</a>
                        <div class="dropdown-menu  dropdown-menu-end">
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item"><i
                                            class="ti ti-file-type-pdf me-1"></i>Importe en CSV </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item"><i
                                            class="ti ti-file-type-xls me-1"></i>Importe en Excel </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <form class="ajax-form" action="{{ route('business.save_candidat') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <!-- J'ai changé la classe 'js-select-etape' par 'js-add-etape' -->
                                ...
                                <!-- LE PETIT MESSAGE (Caché par défaut via d-none) -->
                                <small class="text-danger d-none js-msg-no-etape mt-1">
                                    <i class="ti ti-info-circle"></i> Aucune étape disponible. Création impossible
                                </small>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Catégorie</label>
                                <!-- J'ai changé la classe 'js-select-categorie' par 'js-add-categorie' -->
                ...
                <form id="form_delete_candidat" action="{{ route('business.delete_candidat') }}" method="POST">
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="button" class="btn btn-light me-2 w-100"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.js-select-campagne').on('change', function() {
                ...
                // 5. Lancer le rechargement des candidats (Reset page 1)
                currentPage = 1;
